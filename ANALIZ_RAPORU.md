...
türetilebilir değildir — yani spec satır 71 korunur.
...
bölümü (satır 97-180), spec'te lafzen olmayan ama gerekli olan **16 ayrı kararı** tarih ve gerekçesiyle
...
16 kararı tarihiyle kayıt altına alır (satır 97-180); `ROADMAP.md` kapatılan kararların gerekçesini
