...
/**
 * ÇALIŞMA SAATİ FARKINDALIKLI ZAMAN AŞIMI — spec satır 32-35.
 *
 ...
 * "süresi doldu" saymak spec satır 35'i ihlal ederdi. Böyle kayıtlar pratikte
 ...
 *   2. İşletmenin açık olduğu `ZAMAN_ASIMI_DAKIKA` dakika birikti (spec satır 34-35).
 */
